...
- staged possible-world filtering with explicit known-card, bidding-style, and play-history constraints,
- outcome vectors,
- Pareto fronts,
...
6. possible-world generation from staged known-card, bidding-style, play-history, and deduplicated-world filtering

...
- world masks,
- a first possible-world generator from simple constraints, including first partnership suit-length range and partnership HCP-range bidding constraints,
...
- staged possible-world filtering with explicit known-card, cannot-hold-card, bidding-style (including partnership HCP-range plus seat-level HCP and balanced-shape), explicit follow-suit implication, and play-history constraints,
...
- constructor-local world-construction accounting and explanation traces showing how raw assignment pools are narrowed before later staged filtering,
- outcome vectors,
- Pareto fronts,

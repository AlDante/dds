...
- a first seed-based hidden-seat world constructor driven by recorded play/current-trick card ownership plus simple bidding card-location, suit-length, HCP, and balanced-shape pruning,

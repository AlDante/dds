...
TEST_DIR = ROOT / "test"
BINARY = TEST_DIR / "build" / "alpha_mu"
DEFAULT_LOG = TEST_DIR / "build" / "alpha_mu_full_suite.log"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the full default alpha_mu suite and tee output to a log file."
    )
    ...
    if not args.no_build:
        build_cmd = ["make", "-f", "Makefiles/Makefile_Mac_clang", "alpha_mu"]
